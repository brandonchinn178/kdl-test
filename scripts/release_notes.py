...
BASE_DOWNLOAD_URL = "https://github.com/brandonchinn178/kdl-test/releases/download"
BIN_NAME = "kdl-test"
...
def main() -> None:
    ...
    parser_generate.set_defaults(
        run=lambda args: generate(
            version=args.release_version,
            binaries={label: Path(bin_path) for label, bin_path in args.bin},
        )
    )
